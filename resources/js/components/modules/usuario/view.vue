      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <strong>
                <i class="fab fa-mailchimp mr-1"></i> Nombre Completo 
              </strong>
              <p class="text-muted" v-text="cNombreCompleto"></p>
              <hr />
              <strong>
                <i class="fas fa-envelope-open-text mr-1"></i> Correo Electronico
              </strong>
  ...
  mounted() {
    ...
    setEditarUsuario() {
      ...
      if (
        ...
        this.fillEditarUsuario.oFotografia == undefined
      ) {
